...
{
	Node parentNode;
	parentNode.maxPrefixSum = max(left.maxPrefixSum,
								left.totalSum +
								right.maxPrefixSum);

	parentNode.maxSuffixSum = max(right.maxSuffixSum,
								right.totalSum +
								left.maxSuffixSum);

	parentNode.totalSum = left.totalSum +
						right.totalSum;

	parentNode.maxSubarraySum = max({left.maxSubarraySum,
